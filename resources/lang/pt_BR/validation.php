...
return [
    ...
    */
    ...
    'custom'               => [
        'provider_AutoId' => [
            'unique' => 'Este prestador já se encontra cadastrado! Talvez ele esteja excluido, se for o caso, basta restaura-lo na opção excluídos!',
            'email' => 'Este Email já se encontra cadastrado! Talvez ele esteja excluido, se for o caso, basta restaura-lo na opção excluídos!',
        ],
